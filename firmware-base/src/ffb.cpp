...
void setSoftLimitEnabled(bool on) { softEn_ = on; }
bool softLimitEnabled() { return softEn_; }
void setSoftLimitDeg(float deg) { softDeg_ = deg < 0.0f ? 0.0f : deg; }
float softLimitDeg() { return softDeg_; }
void setSoftLimitK(float k) { softK_ = k < 0.0f ? 0.0f : k; }
float softLimitK() { return softK_; }
